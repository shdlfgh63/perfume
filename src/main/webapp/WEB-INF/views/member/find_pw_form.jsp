		...
		<div class="w3-container w3-card-4">
			<form action="../member/find_id.do" method="post" onsubmit="return allCheck()">
				...
				<div>
					<p>
						<label>ID</label>
						<input class="w3-input" type="text" id="email_input" name="email" placeholder="가입하신 ID를 입력해주세요." required>
					</p>
					<p>
						<label>Email</label>
					...
					<p class="w3-center">
						<button type="submit" id=findBtn class="w3-button w3-block w3-black w3-ripple w3-margin-top w3-round">패스워드 찾기</button>
